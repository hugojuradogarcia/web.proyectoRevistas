			(function() {
				...
				*/
				...
				new SVGDraggable(document.getElementById('drag-element-4'),{
					speed: { reset: 800, active: 100 },
					easing: { reset: mina.elastic, active: mina.easeinout }
				} );

				new SVGDraggable(document.getElementById('drag-element-5'),{
					speed: { reset: 800, active: 100 },
					easing: { reset: mina.elastic, active: mina.easeinout }
				} );

				new SVGDraggable(document.getElementById('drag-element-6'),{
					speed: { reset: 800, active: 100 },
					easing: { reset: mina.elastic, active: mina.easeinout }
				} );

				new SVGDraggable(document.getElementById('drag-element-7'),{
					speed: { reset: 800, active: 100 },
					easing: { reset: mina.elastic, active: mina.easeinout }
				} );
